...
class CaseReport(BaseModel):
    """Investigation report generated by the agent."""

    case_id: str
    anomaly_event: AnomalyEvent
    severity: str
    pattern: str
    merchant_failure_rate: float
    merchant_avg_latency: float
    merchant_event_count: int
    provider_failure_rate: float
    provider_affected_merchants: int
    recommendation: str
